...
const initialState = {
    sclassesList: [{sclassName:"11th"},{sclassName:"12th"},{sclassName:"10th"},{sclassName:"9th"}],
    sclassStudents: [],
    sclassDetails: [],
    subjectsList: [],
    subjectDetails: [],
...
const sclassSlice = createSlice({
    ...
    reducers: {
        ...
        getFailedTwo: (state, action) => {
            state.sclassesList = [{sclassName:"11th"},{sclassName:"12th"},{sclassName:"10th"},{sclassName:"9th"}];
